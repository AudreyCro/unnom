...
9. Taper git remote add suivi du nom que vous souhaitez donner à la connexion suivi de l'uril github de votre repo copiée précedémment, soit quelque chose comme:
git remote add unnom https://github.com/AudreyCro/unnom.git
10. Taper ensuite git push --set-upstream unnom master
